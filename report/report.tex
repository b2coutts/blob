...
$u$ and $v$, with the radii $r_u$ and $r_v$.  We draw a line
that is tangent to both circles and then fill in the rest of the arc,
as we compute the tangent point for the next edge.
